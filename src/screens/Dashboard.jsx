    ...
    <div className="p-4">
      <div className="mb-6">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          {user?.user_metadata?.name ? `Welcome back, ${user.user_metadata.name}` : "Here's your business overview"}
        </p>
      </div>

      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-white dark:bg-[#242424] rounded-2xl p-3 shadow-sm text-center">
      ...
      <div className="bg-white dark:bg-[#242424] rounded-2xl shadow-sm p-4">
